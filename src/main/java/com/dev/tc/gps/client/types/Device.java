 ...
 * 
 */
public class Device implements GPSObject {
	...
	public boolean equals(final Object obj) {
		...
		if (Double.doubleToLongBits(this.activated) != Double
				.doubleToLongBits(other.activated)) {
			return false;
		}
		if (this.bps != other.bps) {
			return false;
		}
		if (Double.doubleToLongBits(this.cycle) != Double
				.doubleToLongBits(other.cycle)) {
			return false;
		}
		if (this.driver == null) {
		...
		if (Double.doubleToLongBits(this.mincycle) != Double
				.doubleToLongBits(other.mincycle)) {
			return false;
		}

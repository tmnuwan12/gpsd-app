 ...
 * 
 */
public class SKY implements GPSObject {
	...
	/**
	 * Latitudinal dilution of precision, a dimensionless factor which should be
	...
	/**
	 * Horizontal dilution of precision, a dimensionless factor which should be
	 * multiplied by a base UERE to get a circular error estimate.
	 * 
	...
	/**
	 * Hyperspherical dilution of precision, a dimensionless factor which should
	 * be multiplied by a base UERE to get an error estimate.
	 * 
	...
	public boolean equals(final Object obj) {
		...
		if (Double.doubleToLongBits(this.altitudeDOP) != Double
				.doubleToLongBits(other.altitudeDOP)) {
			return false;
		}
		if (this.device == null) {
		...
		if (Double.doubleToLongBits(this.horizontalDOP) != Double
				.doubleToLongBits(other.horizontalDOP)) {
			return false;
		}
		if (Double.doubleToLongBits(this.hypersphericalDOP) != Double
				.doubleToLongBits(other.hypersphericalDOP)) {
			return false;
		}
		if (Double.doubleToLongBits(this.latitudeDOP) != Double
				.doubleToLongBits(other.latitudeDOP)) {
			return false;
		}
		if (Double.doubleToLongBits(this.longitudeDOP) != Double
				.doubleToLongBits(other.longitudeDOP)) {
			return false;
		}
		if (Double.doubleToLongBits(this.sphericalDOP) != Double
				.doubleToLongBits(other.sphericalDOP)) {
			return false;
		}
		if (this.tag == null) {
			if (other.tag != null) {
		...
		if (Double.doubleToLongBits(this.timestampDOP) != Double
				.doubleToLongBits(other.timestampDOP)) {
			return false;
		}
